...
- **Specifications** for attribution and provenance in human–agent outputs
- **Reference implementations** that demonstrate the principles in practice
- **Tooling** for lineage tracking, disclosure, and compliance
- **Policy and legal frameworks** that reference HALOS as a normative baseline
...
*This vision document may be updated as the community refines its understanding. Substantive changes follow the [governance process](governance.md).*
